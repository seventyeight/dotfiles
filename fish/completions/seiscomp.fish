...
# exec
complete -f -c seiscomp -n "__fish_seiscomp_using_command exec" -a "(__fish_seiscomp_binaries)"

# complete modules
for mcmd in enable disable start stop restart check status list print
